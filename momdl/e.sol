...
contract SupplyChain {
    ...
    function newUser(
        ...
        bytes32 name,
        Actor actor
    ) public view returns (bool, string) {
        User user;
    ...
    function retailerInnerTransfer(bytes32 commodityID, uint256 timestamp)
        public
        returns (bool, string)
    {
        Commodity commodity = commodityMap[commodityID];
    ...
    function fromRetailerToCustomer(bytes32 commodityID, uint256 timestamp)
        public
        returns (bool, string)
    {
        Commodity commodity = commodityMap[commodityID];
    ...
    function getCommodityRecordsByWhiteList(bytes32 commodityID)
        public
        returns (
            bool,
            string,
        ...
        )
    {
        ...
        return (
            ...
            commodity.produceTime,
            commodity.retailerNames,
            commodity.timestamps,
            commodity.customerName,
            commodity.sellTime
        );
    }

    function getCommodity(bytes32 commodityID, Actor actor)
        returns (
            bool,
            string,
            bytes32 producerName,
